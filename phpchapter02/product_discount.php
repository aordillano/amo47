<?php
    ...
    // note: php is strongly typed, so you don't have to convert something
    // from one type to another because it automatically does that
...
<html>
    ...
    <body>
        ...
        <br>
        <!-- we calculated these so no need for htmlspecialchars -->
